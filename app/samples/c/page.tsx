/**
 * SAMPLE C — "Tag Cloud / Direct" (shruti.framer.ai energy)
 *
 * - Small tag pills establish role before the name
 * - Name in medium serif — prominent but never off-screen
 * - Single clear bio sentence, then CTAs
 * - Experience as an inline strip with dividers
 * - Work grid same cards, slightly tighter
 */

import Link from 'next/link'

const tags = ['Product Design', 'UX Research', 'Systems Thinking', 'Currently at Relay']
...
export default function SampleC() {
  return (
    <main id="main-content">

      {/* ── Hero ── */}
      <section style={{ paddingTop: 64, paddingBottom: 72 }} className="wrap">
        ...
        {/* Bio — one direct sentence + expansion */}
        <p style={{
          fontFamily: 'var(--font-sans)',
          ...
          I design products that are clear to use, honest in their constraints,
          and respectful of the people who depend on them every day.
          My best work lives in the details nobody noticed until they were gone.
        </p>
      ...
      <section className="wrap" style={{ paddingBottom: 64 }}>
        ...
        >
          <span style={{
            ...
            flexShrink: 0, marginRight: 28, paddingTop: 1,
            alignSelf: 'center',
          }}>
            Experience
          </span>
            ...
            <div key={exp.year} style={{
              ...
              <div>
                ...
                <p style={{
                  ...
                  color: 'var(--mute)', marginTop: 1, whiteSpace: 'nowrap',
                }}>
                  {exp.company}
                </p>
              </div>
              {i < experience.length - 1 && (
                <span style={{ color: 'var(--rule-strong)', fontSize: 16, flexShrink: 0 }}>·</span>
              )}
            </div>
          ))}
        </div>
      ...
      <section id="work" className="wrap" style={{ paddingBottom: 80 }}>
        <div style={{
          ...
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: 12, color: 'var(--mute)' }}>
            02 case studies · 04 in progress
          </p>
        </div>
        ...
        <div className="work-grid">
          ...
          <div className="work-card-anchor" style={{ pointerEvents: 'none', opacity: 0.45 }} aria-hidden="true">
      ...
      <style>{`
        .exp-strip { scrollbar-width: none; }
